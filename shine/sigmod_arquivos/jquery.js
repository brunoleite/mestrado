    ...
    var NivoSlider = function(element, options){
        ...
        if(settings.controlNav){
			...
			if(vars.currentImage.attr('alt') != ''){
				var sliderImg = slider.children("img");
				sliderImg.each(function(i){
						var title = $(this).attr('alt');
						if (title != ''){nivoControl.append('<li><a class="nivo-control" rel="'+ (i++) +'">'+ (title) +'</a></li>');}
						else {nivoControl.append('<li><a class="nivo-control" rel="'+ (i++) +'">'+ (i++) +'</a></li>');}
					});
				nivoControl.wrapInner('<ul id="fTabs">');
			} else {
